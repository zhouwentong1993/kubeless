...
import (
	...
	"github.com/kubeless/redis-trigger/pkg/client/clientset/versioned/scheme"
...
func (c *KubelessV1beta1Client) RedisTriggers(namespace string) RedisTriggerInterface {
	return newRedisTriggers(c, namespace)
}
