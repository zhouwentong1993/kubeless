	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubelessV1beta1().KafkaTriggers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubelessV1beta1().KafkaTriggers(namespace).Watch(context.TODO(), options)
			},
		},
		&kubelessv1beta1.KafkaTrigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kafkaTriggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubelessv1beta1.KafkaTrigger{}, f.defaultInformer)
}
