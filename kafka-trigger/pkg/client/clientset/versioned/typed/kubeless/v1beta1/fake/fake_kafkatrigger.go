...
func (c *FakeKafkaTriggers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.KafkaTrigger, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaTriggers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.KafkaTriggerList, err error) {
	obj, err := c.Fake.
	...
	list := &v1beta1.KafkaTriggerList{ListMeta: obj.(*v1beta1.KafkaTriggerList).ListMeta}
...
func (c *FakeKafkaTriggers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeKafkaTriggers) Create(ctx context.Context, kafkaTrigger *v1beta1.KafkaTrigger, opts v1.CreateOptions) (result *v1beta1.KafkaTrigger, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaTriggers) Update(ctx context.Context, kafkaTrigger *v1beta1.KafkaTrigger, opts v1.UpdateOptions) (result *v1beta1.KafkaTrigger, err error) {
	obj, err := c.Fake.
...
func (c *FakeKafkaTriggers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeKafkaTriggers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(kafkatriggersResource, c.ns, listOpts)
...
func (c *FakeKafkaTriggers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.KafkaTrigger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(kafkatriggersResource, c.ns, name, pt, data, subresources...), &v1beta1.KafkaTrigger{})
